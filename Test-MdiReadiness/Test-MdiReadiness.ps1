<#
    .NOTES
        ...
        ----------------------------------------------------------------------------
        IMPORTANT - THIS IS NOT AN OFFICIAL MICROSOFT SCRIPT
        ...
        For the official, supported tool use the original script from the
        repository above.
...
<p class="disclaimer"><b>Not an official Microsoft script.</b> This report was produced by an unofficial, modified version of Test-MdiReadiness.ps1, not affiliated with, endorsed by or supported by Microsoft. It is provided "as is", with no warranty and no liability of any kind, and its findings must be verified against the current <a href="https://learn.microsoft.com/defender-for-identity/">official documentation</a> before you act on them. Use at your own risk.</p>
</div>
@@SCRIPT@@
</body></html>
'@
